package org.raindrop.common.utils.json.parser;

import org.raindrop.common.exception.BaseException;
import org.raindrop.common.utils.json.model.JsonArray;
import org.raindrop.common.utils.json.model.JsonObject;
import org.raindrop.common.utils.json.tokenizer.Token;
import org.raindrop.common.utils.json.tokenizer.TokenList;
import org.raindrop.common.utils.json.tokenizer.TokenType;

/**
 * created by yangtong on 2024/5/18 23:16
 *
 * @Description: 语法分析
 */
public class Parser {
    ...
    private Object parse() {
        ...
        if (token == null) {
            ...
            throw new BaseException("Parse error, invalid Token.");
        }
    }
        ...
        while (tokens.hasMore()) {
            ...
            switch (tokenType) {
                ...
                case END_DOCUMENT:
                    ...
                    return jsonObject;
                default:
                    throw new BaseException("Unexpected Token.");
            }
        }
